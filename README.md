...
To get started, navigate [here](https://notebooks.gesis.org/binder/jupyter/user/lmjacoby-ai_semiconductors-km62aw19/apps/ai_semiconductors/prediction_tool/Energy_plot.ipynb)
